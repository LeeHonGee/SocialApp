...
public class CircleTimerView extends View
{
    ...
    private int currentTime=5; // seconds
...
//    	System.out.println("------000000");
        currentTime = (int) (10 / (2 * Math.PI) * currentRadian * 60);
//        System.out.println("----currentTime-"+currentTime+"----currentRadian--"+currentRadian);
        // Assist lines
...
//        canvas.drawText("45", getMeasuredHeight() / 2 - radius + circleStorkeWidth / 2 + gapBetweenCircleAndLine + longerLineLength + gapBetweenNumberAndLine + textLength / 2, cy + getFontHeight(numberPaint) / 2, numberPaint);
        ...
        // TimerNumber
        canvas.save();
        canvas.drawText(currentTime / 60+ "''" , cx+30, cy + getFontHeight(timerNumberPaint) / 2, timerNumberPaint);
...
//        canvas.restore();
    ...
    public void circleTime(int ticket){
    	currentTime=ticket*6;
    	currentRadian=(float) (currentTime*(2 * Math.PI)/600);
    	invalidate();
//    	startTimer();
