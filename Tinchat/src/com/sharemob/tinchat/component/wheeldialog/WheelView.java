...
package com.sharemob.tinchat.component.wheeldialog;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x0000000,0x0000000, 0x0000000};
	...
	// Wheel Values
	private AbstractWheelTextAdapter adapter = null;
	...
	private GlobalParams globalParams=GlobalParams.getInstance();
	/**
	 * Constructor
	 */
	 ...
	 * @return the adapter
	 */
	public AbstractWheelTextAdapter getViewAdapter() {
		return adapter;
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (itemsPaint == null) {//| Paint.FAKE_BOLD_TEXT_FLAG
			itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG );
			itemsPaint.density = getResources().getDisplayMetrics().density;
			itemsPaint.setTextSize(TEXT_SIZE);
			itemsPaint.setTypeface(globalParams.localFontTypeface);
		}

		if (valuePaint == null) {//| Paint.FAKE_BOLD_TEXT_FLAG 
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
			valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(TEXT_SIZE+5);
			valuePaint.setTypeface(globalParams.localFontTypeface);
			valuePaint.setShadowLayer(0.1f, 0, 0.2f, 0x676767);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.datepicker_val);
		}
		...
		setBackgroundResource(R.drawable.datepicker_bg);
	}
	...
	private int getMaxTextLength() {
		AbstractWheelTextAdapter adapter = getViewAdapter();
		if (adapter == null) {
			return 0;
		}
		
		int adapterLength = adapter.getTextSize();
		if (adapterLength > 0) {
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (!isScrollingPerformed && (valueLayout == null || valueLayout.getWidth() > widthItems)) {
			String text = getViewAdapter() != null ? getViewAdapter().getItemText(currentItem) .toString(): null;
...
//		canvas.drawRect(0, center + offset, getWidth(), getHeight(), paint);
		...
		paint.setStyle(Style.FILL);
		paint.setColor(Color.parseColor("#fb5552"));
		canvas.drawLine(0+40, center - offset, getWidth()-40, center - offset, paint);
		canvas.drawLine(0+40, center + offset, getWidth()-40, center +offset, paint);
	}
