...
public class LocalProgressBar extends ProgressBar {
	...
	public LocalProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }
	public LocalProgressBar(Context context, AttributeSet attrs, int defStyle) {
