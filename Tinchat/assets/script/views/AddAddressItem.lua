...
local layout_header={
	...
	layout_title_text("right|center_vertical","btn_title_right_next","保存")
}
...
function onController()
	...
	function()
		...
		elseif(detailedness_val=="")then
			...
			local data={uid=UserInfo.uid,receiver=receiver_val,telephone=telephone_val,address=address_val,address=address_val,detailedness=detailedness_val}
			local url=URL_User(10043,cjson.encode(data))
